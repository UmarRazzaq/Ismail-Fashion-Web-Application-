            ...
            <div class="main">
                <div class="col-main">
                    ...
                    <div class="cat-product" style="">
                        ...
                        try {
                            $query = $conn->prepare("SELECT * FROM products p JOIN category c ON c.id = p.category_id WHERE c.cat_slug = 'print'");
                            $query->execute();
                    ...
                    <div class="product-grid grid_item">
                        <div class="hover2">
                            <div class="p-image pro-hover">
                                <a href="#" title='.$row['name'].' class="p-image">
